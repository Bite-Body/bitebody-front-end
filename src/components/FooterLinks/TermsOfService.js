  ...
  render() {
    return (
        ...
        <div className="container">
          ...
          <p>
          The Bitebody website located at bitebody.xyz is a copyrighted work belonging to Bitebody. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.  
          </p>
          <p>
